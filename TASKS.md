...
## Active Task
- [ ] ID: PHASE-04T: Private Telegram owner-smoke (Gate 4T.0 `approved` locally; Gate 4T.1 is the only active task, staging-only remote authorization is granted, and P4T-05 is paused at the owner-operated Supabase sign-in checkpoint; ADRs 046–067)
